...
def main(): 
    ...
    Run_num = int(input("Enter the First Run Number: "))
    Run_num_2 = int(input("Enter the Second Run Number: "))
    directory = f"/Users/danielcarber/Documents/SBND/Noise Analysis/Plots/run{Run_num}/"
    if not os.path.exists(directory):
        os.mkdir(directory)
    files=[]
    files.append(uproot.open(f"/Users/danielcarber/Documents/SBND/Noise Analysis/noise_output_run{Run_num}.root"))
